      ...
      <div className="flex flex-row w-full pt-4 border-b border-solid border-slate-800 pl-3 pr-10">
        ...
        <div>
          ...
          <div className="flex flex-row justify-between mt-4 mr-20 ml-5 mb-5">
            <React react={tweet.replies} src="src/assets/Reply.svg" alt="Reply" />
            <React react={tweet.retweets} src="src/assets/Retweet.svg" alt="Retweet" />
            <React react={tweet.favorites} src="src/assets/React.svg" alt="React" />
